...
![Version: 0.18.18](https://img.shields.io/badge/Version-0.18.18-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| tjeneste.version | string | `"r4.4.0-py313-2026.08.11T13_49Z"` |  |
| tolerations | list | `[]` |  |

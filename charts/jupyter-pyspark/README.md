...
![Version: 0.11.19](https://img.shields.io/badge/Version-0.11.19-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| tjeneste.version | string | `"py313-spark3.5.3-2026.02.16T09_36Z"` |  |
| tolerations | list | `[]` |  |

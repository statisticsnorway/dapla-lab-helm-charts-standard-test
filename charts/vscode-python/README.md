...
![Version: 0.17.19](https://img.shields.io/badge/Version-0.17.19-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| tjeneste.version | string | `"r4.4.0-py313-2026.04.21T14_27Z"` |  |
| tolerations | list | `[]` |  |

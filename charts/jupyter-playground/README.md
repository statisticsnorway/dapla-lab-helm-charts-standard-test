...
![Version: 0.16.12](https://img.shields.io/badge/Version-0.16.12-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| tjeneste.version | string | `"r4.4.0-py311-2025.10.25T20_55Z"` |  |
| tolerations | list | `[]` |  |

...
![Version: 0.16.7](https://img.shields.io/badge/Version-0.16.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| tjeneste.version | string | `"r4.4.0-py311-2025.10.02T09_55Z"` |  |
| tolerations | list | `[]` |  |

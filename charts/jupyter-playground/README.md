...
![Version: 0.15.8](https://img.shields.io/badge/Version-0.15.8-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| https://statisticsnorway.github.io/dapla-lab-helm-charts-library | library-chart | 4.4.5 |
...
| tjeneste.version | string | `"r4.4.0-py311-2025.08.07T06_08Z"` |  |
| tolerations | list | `[]` |  |

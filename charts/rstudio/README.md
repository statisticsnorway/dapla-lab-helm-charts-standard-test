...
![Version: 0.15.12](https://img.shields.io/badge/Version-0.15.12-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| tjeneste.version | string | `"r4.4.0-2026.08.12T12_20Z"` |  |
| tolerations | list | `[]` |  |
